...
!+ Nongnuch Artrith and Alexander Urban  This Source Code Form is
...
!+ one at http://mozilla.org/MPL/2.0/.  This program is distributed in
!+ the hope that it will be useful, but WITHOUT ANY WARRANTY; without
!+ even the implied warranty of MERCHANTABILITY or FITNESS FOR A
!+ PARTICULAR PURPOSE.  See the Mozilla Public License, v. 2.0, for
!+ more details. ------------------------------------------------------
!+ --------------- If you make use of AENET for your publication,
!+ please cite: [1] N. Artrith and A. Urban, Comput. Mater. Sci. 114
!+ (2016) 135-150. [2] J. Behler and M. Parrinello, Phys. Rev. Lett. 98
!+ (2007) 146401.  If you used the Chebyshev descriptor, please cite:

...
* References
  ...
  descriptor/, please cite: [[[bibliography][3]]] N. Artrith, A. Urban, and Gerbrand Ceder,
  ...
  of the local structural environment, please cite: [[[bibliography][5]]] A. P. Bartók,
...
** Invariant basis (structural fingerprint)
   ...
   expansion [[[bibliography][3]]] and the invariant /symmetry function/ basis by Behler and
   Parrinello [[[bibliography][2,4]]].  The code is designed such that implementing
...
* Bibliography
  ...
  =[3]= N. Artrith, A. Urban, and Gerbrand Ceder,

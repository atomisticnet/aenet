...
#+INCLUDE: "../README.org" :lines "4-"

#+INCLUDE: "./binary-installation.org"
...
* Version queries and release versions
  ...
  =v2.0.5=. CMake reads this file and automatically reconfigures on changes.
  ...
  binaries should be relinked when adopting this convention. Static library
  names and existing executable suffixes are unchanged. Legacy Makefiles
  also read =src/VERSION= for executable queries and retain their existing

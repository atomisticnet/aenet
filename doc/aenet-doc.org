...
#+TITLE: *The Atomic Energy Network (ænet) (release 1.0.0)*
...
* References
  ...
  in: [[[bibliography][2]]] J. Behler and M. Parrinello, /Phys. Rev. Lett./ *98*
  (2007) 146401.

  If the local structural environment is represented by /symmetry
  functions/, please cite: [[[bibliography][3]]] J. Behler, /J. Chem. Phys./ *134*
  (2011) 074106.

  If the generalized spherical harmonics are used for the representation
  of the local structural environment, please cite: [[[bibliography][4]]] A. P. Bartók,
  M. C. Payne, R. Kondor, and G. Csányi, /Phys. Rev. Lett./ *104*
  (2010) 136403.

  The L-BFGS-B method is provided by a third party library.  Whenever
  the method is used for training, please cite: [[[bibliography][5]]] R. H. Byrd, P. Lu
  and J. Nocedal, /SIAM J. Sci. Stat. Comp./ *16* (1995) 1190-1208.

  The references for the Levenberg-Marquardt method are: [[[bibliography][6]]]
  K. Levenberg, /Q. Appl. Math./ *2* (1944) 164–168; [[[bibliography][7]]]
...
** Invariant basis (structural fingerprint)
   ...
   by Behler and Parrinello [[[bibliography][2,3]]] but the code is designed such that
...
* Bibliography
  ...
  =[2]= J. Behler and M. Parrinello,
  [[http://dx.doi.org/10.1103/PhysRevLett.98.146401][/Phys. Rev. Lett./ *98* (2007) 146401]].

  =[3]= J. Behler, [[http://scitation.aip.org/content/aip/journal/jcp/134/7/10.1063/1.3553717][/J. Chem. Phys./ *134* (2011) 074106]].

  =[4]= A. P. Bartók, M. C. Payne, R. Kondor, and G. Csányi,
  [[http://link.aps.org/doi/10.1103/PhysRevLett.104.136403][/Phys. Rev. Lett./ *104* (2010) 136403]].

  =[5]= R. H. Byrd, P. Lu and J. Nocedal,

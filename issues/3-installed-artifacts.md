...
[versioning policy](../closed-issues/2-canonical-versioning.md). Settle
runtime-library placement with [packaging](7-relocatable-packaging.md) so
extracted archives can be relocated. Issue 7 owns dependency bundling and
clean-environment execution checks. Do not add developer suffix options
